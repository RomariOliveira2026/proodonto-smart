      ...
      >
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-12 bg-surface dark:bg-bg">
          ...
          >
            ...
            {/* Card do formulário — profundidade no dark mode */}
            <div className="login-form-card rounded-3xl border border-gray-100/80 dark:border-white/[0.06] bg-white/80 dark:bg-card/90 backdrop-blur-sm p-7 sm:p-8 lg:p-0 lg:border-0 lg:bg-transparent lg:backdrop-blur-none lg:shadow-none">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  ...
                  >
                    {loading ? (
                      <>
                        <Loader2 className="w-5 h-5 login-spinner" />
                        Entrando...
                      </>
                    ) : (
                      <>
              ...
              >
                <Link to="/" className="text-primary font-medium hover:text-primary-light transition-colors">
                  ← Voltar ao site
                </Link>
              </motion.p>
              ...
              <motion.div
                ...
                className="mt-6 p-4 rounded-xl bg-primary/5 dark:bg-primary/10 border border-primary/10 dark:border-primary/20 text-center"
              >
      ...
      <AnimatePresence>
        {exiting && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-surface dark:bg-bg pointer-events-none"
            aria-hidden
          />
        )}
      </AnimatePresence>
